...
alias free-mem="free -m | awk '/Mem:/ { printf(\"%d%%\", \$3/\$2*100) }'"
alias free-disk="df -h / | awk 'NR==2 {print \$5}'"
alias free-cpu="top -bn1 | grep \"Cpu(s)\" | awk '{ print 100 - \$8 \"%\" }'"
...
alias poker="ssh cli.poker"
alias utf8-demo='curl https://www.cl.cam.ac.uk/~mgk25/ucs/examples/UTF-8-demo.txt'
alias rr='curl -s -L https://raw.githubusercontent.com/keroserene/rickrollrc/master/roll.sh | bash'
# curl qrenco.de/raafat.io'
# curl https://www.toptal.com/developers/gitignore/api/dotnetcore
