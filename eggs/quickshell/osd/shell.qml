        ...
        RowLayout {
          ...
          Rectangle {
            ...
            Rectangle {
              ...
              property double volumeRatio: Pipewire.defaultAudioSink?.audio.volume ?? 0
              // property double volumRatioOver: 1.0
              property double volumeRatioMax: 2.0
              // property bool isOver: volumRatio > volumRatioOver

              // color: isOver ? "#77ff0000" : "#77ffffff"
              color: "#77ffffff"
              implicitWidth: parent.width/volumeRatioMax * Math.min(volumeRatioMax, volumeRatio)
              radius: parent.radius
            }
          }

          Text {
            text: (100 * progressBar.volumeRatio).toFixed(0)
            color: "#ffffff"
          }
        }
      }
